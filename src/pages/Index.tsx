...
const PAINTINGS = [
  {
    ...
    title: "Гайя",
    theme: "Единство с миром",
    description: "Образ глубокой связи с природой и всем живым — для тех, кто ищет гармонию.",
  },
  {
    id: 2,
    image: IMAGES.painting3,
    title: "Русалка",
    theme: "Живая уникальность",
    description: "Картина о неповторимости каждой души — её силе, глубине и красоте.",
  },
  {
    id: 3,
    ...
    title: "Внутри",
    theme: "Исцеление",
    description: "Нежный образ для отпускания боли и обретения внутреннего покоя.",
  },
];
